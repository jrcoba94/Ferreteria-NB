...
private TableRowSorter trsFiltro;
    ...
    private void initComponents() {
        ...
        jPanel1.add(cmbBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 70, -1, -1));
    ...
    private void jTextFieldParametroBusquedaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldParametroBusquedaKeyTyped
        ...
        trsFiltro = new TableRowSorter(jTableListarCliente.getModel());
        jTableListarCliente.setRowSorter(trsFiltro);
...
public void Filtro()
    {
        trsFiltro.setRowFilter(RowFilter.regexFilter(jTextFieldParametroBusqueda.getText(),0,1,2));
    }
    /**
